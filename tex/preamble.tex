...
% The human medial temporal lobe, and, in particular, the hippocampus, is a crucial brain structure for both spatial navigation and memory function. 

% space based on rodents. advance it to humans.
% memory spatial distinction. bring it together
